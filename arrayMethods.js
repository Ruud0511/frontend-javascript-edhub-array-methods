...
const listInventors = inventors.filter ((inventor) => {
  return inventor.year >= 1500 && inventor.year <= 1599;
});

console.log(listInventors);
...
const listYearOfBirth = inventors.map ((inventor) => {
  return inventor.year
});

console.log(listYearOfBirth);
...
const nameInventor = inventors.map ((inventor) =>{
